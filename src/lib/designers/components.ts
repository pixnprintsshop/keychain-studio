...
const LOADERS: Record<DesignerId, () => Promise<DesignerModule>> = {
	standaloneNameKeychain: () => import('$lib/components/TextOutlineDesigner.svelte'),
	...
	classicNameTagKeychain: () => import('$lib/components/BasicNameDesigner.svelte'),
	...
	ribbonBowKeychain: () => import('$lib/components/BowKeychainDesigner.svelte'),

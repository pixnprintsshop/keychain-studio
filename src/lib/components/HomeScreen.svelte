<script lang="ts">
    ...
    function getUnderMaintenanceDesigners(): Set<StyleName> {
        ...
        const envList = import.meta.env.VITE_UNDER_MAINTENANCE_DESIGNERS as
            | string
            | undefined;
    ...
    const DESIGNERS: DesignerItem[] = [
        ...
        },
        {
            ...
            title: "Bow Keychain",
            description:
                "Text on a bow-shaped base with optional keyring—cute and personal.",
    ...
    const showLicenseCta = $derived(
        !licenseStatus || licenseStatus.type !== "licensed",
    );
            ...
            <div
                ...
                <p class="mt-1 text-amber-800">
                    {Array.from(DESIGNERS_UNDER_MAINTENANCE)
                        ...
                        .join(", ")}{Array.from(DESIGNERS_UNDER_MAINTENANCE)
                        .length === 1
                        ? " is"
                        : " are"} temporarily unavailable. You can keep using the
                    other designers, or
                    <a
                        target="_blank"
                ...
                <div
                    ...
                    {#if designer.previewImageSrc}
                        ...
                        <div
                            ...
                            <button
                                type="button"
                                class="absolute right-3 top-3 flex size-8 items-center justify-center rounded-full bg-white/90 text-slate-500 shadow-sm transition pointer-events-auto hover:bg-white hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 {isPaidDesigner(
                                    designer.id,
                    ...
                    <div class="aspect-4/3 w-full overflow-hidden bg-slate-100">
                        <img
                            ...
                            class="h-full w-full object-cover transition {isUnderMaintenance(
                                designer.id,
                            )
                                ? ''

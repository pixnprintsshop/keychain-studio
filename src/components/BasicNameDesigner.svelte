<script lang="ts">
  ...
  function rebuildMeshes() {
    ...
    if (outerRectPath)
      borderClipper.AddPath(outerRectPath, ClipperLib.PolyType.ptSubject, true);
    if (innerRectPath)
      borderClipper.AddPath(innerRectPath, ClipperLib.PolyType.ptClip, true);
    ...
    if (topCirclePath)
      rectHoleClipper.AddPath(topCirclePath, ClipperLib.PolyType.ptClip, true);
    ...
    if (discHolePath)
      topDiffClipper.AddPath(discHolePath, ClipperLib.PolyType.ptClip, true);
...
<main class="h-dvh w-dvw bg-slate-50 p-4">
  ...
  >
    ...
    >
      ...
      <div class="min-h-0 flex-1 overflow-y-auto overflow-x-hidden p-4 pt-0 pr-1">
        <div
        ...
        >
          ...
          <label class="grid gap-1.5">
            <div class="flex items-center justify-between gap-2">
              <span class="text-xs font-medium text-slate-700">Text depth</span>
        ...
        <div class="grid grid-cols-1 gap-4">
          ...
          >
            ...
            <label class="grid gap-1.5">
              <span class="text-xs font-medium text-slate-700">Color</span>
              <div class="flex items-center gap-2">
                <input
                  class="h-10 w-10 rounded-xl"
                  type="color"
            ...
            <div class="grid gap-1.5">
              ...
              >
                <button
                  ...
                  onclick={() => (keyringPosition = "topLeft")}
                  title="Top left"
                ...
                <button
                  ...
                  'topCenter'
                    ? 'border-indigo-500 bg-indigo-100 text-indigo-700'
                    : 'border-slate-200 bg-white text-slate-600 hover:border-slate-300 hover:bg-slate-50'}"
                  onclick={() => (keyringPosition = "topCenter")}
                  title="Top center"
                  aria-pressed={keyringPosition === "topCenter"}
                >
                  ↑
                </button>
                <button
                  ...
                  'topRight'
                    ? 'border-indigo-500 bg-indigo-100 text-indigo-700'
                    : 'border-slate-200 bg-white text-slate-600 hover:border-slate-300 hover:bg-slate-50'}"
                  onclick={() => (keyringPosition = "topRight")}
                  title="Top right"
                  aria-pressed={keyringPosition === "topRight"}
                >
                  ↗
                </button>
                <button
                  ...
                  'leftCenter'
                    ? 'border-indigo-500 bg-indigo-100 text-indigo-700'
                    : 'border-slate-200 bg-white text-slate-600 hover:border-slate-300 hover:bg-slate-50'}"
                  onclick={() => (keyringPosition = "leftCenter")}
                  title="Left center"
                  aria-pressed={keyringPosition === "leftCenter"}
                >
                  ←
                </button>
                ...
                <button
                  ...
                  'rightCenter'
                    ? 'border-indigo-500 bg-indigo-100 text-indigo-700'
                    : 'border-slate-200 bg-white text-slate-600 hover:border-slate-300 hover:bg-slate-50'}"
                  onclick={() => (keyringPosition = "rightCenter")}
                  title="Right center"
                  aria-pressed={keyringPosition === "rightCenter"}
                >
                  →
                </button>
              </div>

<script lang="ts">
    ...
    import baseStlUrl from "../assets/stl/dogtag/base.stl?url";
    import borderStlUrl from "../assets/stl/dogtag/border.stl?url";
        ...
        >
            ...
            <div class="min-h-0 flex-1 space-y-4 overflow-y-auto overflow-x-hidden p-4 pt-0">
                <p class="text-xs text-slate-500">
                    Personalize the dog tag with your text. Border and text use the same depth and color, on top of the base.
                </p>
                ...
                <div>
                    <div class="mb-1 flex items-center justify-between">
                        <label for="dogtag-text-scale" class="text-xs font-medium text-slate-700">
                            Text scale
                        </label>
                ...
                <div>
                    <div class="mb-1 flex items-center justify-between">
                        <label for="dogtag-text-depth" class="text-xs font-medium text-slate-700">
                            Text & border depth
                        </label>
                ...
                <div>
                    <label class="flex items-center gap-2" for="dogtag-text-color">
                        <span class="text-xs font-medium text-slate-700">Text & border color</span>
                        <input
                ...
                <div>
                    <label class="flex items-center gap-2" for="dogtag-base-color">
                ...
                <DesignerExportToolbar
                    onSnapshot={() => {
                        if (renderer && scene && camera)
                            downloadSnapshot(renderer, scene, camera, "dog-tag");
                    }}

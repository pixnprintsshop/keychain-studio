<main
    class="flex min-h-dvh flex-col items-center justify-center bg-slate-50 px-4 py-12"
>
    <div
        class="flex w-full max-w-md flex-col items-center rounded-2xl border border-slate-200 bg-white p-8 shadow-[0_1px_2px_rgba(15,23,42,0.06),0_12px_30px_rgba(15,23,42,0.07)]"
    >

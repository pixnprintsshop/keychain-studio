            ...
            <div class="p-6">
                    ...
                    <div
                        ...
                        {#if licenseStatus.type === "trial"}
                            ...
                            <p class="mt-2 text-xs text-slate-500">
                                All features are available during trial.
                                Activate a license to continue after trial
                                expires.
                            </p>
                ...
                <div
                    ...
                    <p class="text-xs text-slate-600 space-y-2">
                        For now, license purchase is manual while we work on an
                        integrated payment option.
                    </p>
                    <ol
                        class="mt-2 list-decimal list-inside text-xs text-slate-600 space-y-1.5">
                        <li>
                            Contact us via <a
                        ...
                        <li>
                            After payment, we’ll send you your license code.
                        </li>
                        <li>
                            Enter the code below and click <strong
                                >Activate License</strong> to use it in the app.
                        </li>
                    </ol>
                </div>
